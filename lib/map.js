...
var ReactMap = function (_React$Component) {
    ...
    function ReactMap(props) {
        ...
        _this.componentDidMount = function () {
            ...
            _this.props.mapProvider.initialize(map, {
                center: {
                    lat: _.isNumber(_this.props.lat) ? _this.props.lat : _this.props.initialLat,
                    lng: _.isNumber(_this.props.lng) ? _this.props.lng : _this.props.initialLng
                },
                dimension: {
