...
var ReactMap = function (_React$Component) {
    ...
    function ReactMap(props) {
        ...
        _this.componentDidMount = function () {
            var mapDiv = _this.refs.mapDiv;
            _this.props.mapProvider.initialize(mapDiv, {
                center: {
                    lat: _this.props.lat,
                    lng: _this.props.lng
                },
        ...
        value: function render() {
            ...
            var children = React.Children.map(this.props.children, function (child) {
                var newChild = React.cloneElement(child, Object.assign({}, child.props, {
                    pointToLatLng: _this2.props.mapProvider.pointToLatLng,
                    latLngToPoint: _this2.props.mapProvider.latLngToPoint
